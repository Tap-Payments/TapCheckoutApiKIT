...
internal extension NetworkManager {
    ...
    static private var applicationHeaderValue: String {
        ...
        let localeIdentifier = TapCheckoutApiManager.sharedApiManager.localeIdentifier
    ...
    static func secretKey() -> String {
        return (TapCheckoutApiManager.sharedApiManager.sdkMode == .sandbox) ? TapCheckoutApiManager.sharedApiManager.secretKey.sandbox : TapCheckoutApiManager.sharedApiManager.secretKey.production
    }
    ...
    static private func applicationStaticDetails() -> [String: String] {
        ...
        let sdkPlistInfo = TapBundlePlistInfo(bundle: Bundle(for: TapCheckoutApiManager.self))
